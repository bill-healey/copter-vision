...
class RCPPMGenerator:
    ...
    class StreamWriterThread(threading.Thread):
        ...
        def __init__(self, pyaudio, stream, shared_data):
    ...
    def encode_frame(self):
        ...
        self.shared_data['frame'] = bitstream + self.generate_bitstream(self.FRAME_DURATION_MS - bitstream_duration_ms, self.SIGNAL_LOW)
